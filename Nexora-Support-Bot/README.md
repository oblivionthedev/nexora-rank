...
- `/ticket claim`, `/ticket close`, `/ticket close-reason`, `/ticket ask-close`, `/ticket rename`, `/ticket add`, and `/ticket remove` organize agent work.
- DM messages and attachments relay in both directions.
- Member DMs receive a clean ✅ reaction after successful delivery.
- The official Support Team role `1543548810272309299` always receives ticket and transcript access.
...
6. Confirm the official Support Team role exists, run `/setup`, then publish `/panel`.
