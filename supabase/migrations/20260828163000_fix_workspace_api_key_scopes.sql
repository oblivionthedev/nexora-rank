...
begin
  ...
  values(p_workspace_id,'Workspace API key',prefix,digest_hex,array['activity:write','members:read','ranks:read','ranks:write','audit:read','webhooks:write']::text[],actor_id) returning id into new_id;
