...
export function ApiKeyControl({ workspaceId, currentPrefix }: { workspaceId: string; currentPrefix?: string | null }) {
  ...
  return (
    <div className="api-key-control">
      <div>
        ...
        <p className="mt-2 text-xs leading-6 text-white/48">Exactly 25 characters. Replacing it immediately disables the previous key.</p>
      </div>
      {visibleKey ? (
      ...
      <form action={action}>
        ...
        <button className="pill pill-ghost" type="submit" disabled={pending}>
