...
import { Activity, Bot, Check, Copy, Gamepad2, GitBranch, KeyRound, LogOut, Plus, ShieldCheck, UsersRound, Webhook } from "lucide-react";
...
export default async function DashboardPage({ searchParams }: { searchParams: Promise<{ error?: string }> }) {
  ...
  if (!membership) redirect(`/onboarding${params.error ? `?error=${params.error}` : ""}`);
