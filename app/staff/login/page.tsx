    ...
    <main className="min-h-screen bg-[#080806] px-5 py-10 text-white">
      <div className="mx-auto flex min-h-[calc(100vh-5rem)] max-w-xl items-center">
        <section className="glass-strong w-full overflow-hidden rounded-[32px] border border-white/10 p-7 sm:p-10">
          ...
          <div className="mt-10 flex size-14 items-center justify-center rounded-2xl bg-[#d3aa70]/12 text-[#e8c489] ring-1 ring-[#d3aa70]/25">
          ...
          {signedIn ? (
            ...
            <Link href="/login?next=/staff" className="mt-8 inline-flex min-h-12 w-full items-center justify-center rounded-full bg-[#ece5da] px-6 text-sm font-bold text-[#15110d] transition hover:bg-white">
