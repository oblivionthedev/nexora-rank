    ...
    <main className="site-shell overflow-hidden">
      <nav className="landing-nav" aria-label="Primary navigation">
        ...
        <div className="flex items-center gap-2">
          ...
          <Link href="/dashboard" className="button-glow inline-flex h-10 items-center gap-2 rounded-xl px-4 text-sm font-semibold text-white">Open app <ArrowRight className="size-3.5" /></Link>
        </div>
      </nav>
      ...
      <section className="hero-section px-5 pb-24 pt-20 sm:px-8 sm:pt-28 lg:pb-36 lg:pt-36">
        ...
        <div className="mx-auto max-w-7xl">
          <div className="mx-auto max-w-4xl text-center">
            <div className="reveal-up inline-flex items-center gap-2 rounded-full border border-blue-400/20 bg-blue-400/[0.07] px-3 py-1.5 text-xs font-medium text-blue-200">
              <span className="relative flex size-1.5"><span className="absolute inline-flex size-full animate-ping rounded-full bg-blue-300 opacity-60" /><span className="relative inline-flex size-1.5 rounded-full bg-blue-300" /></span>
            ...
            <div className="reveal-up delay-3 mt-9 flex flex-col items-center justify-center gap-3 sm:flex-row">
              <Link href="/dashboard" className="button-glow inline-flex h-12 min-w-44 items-center justify-center gap-2 rounded-xl px-5 text-sm font-semibold text-white">Start your workspace <ArrowRight className="size-4" /></Link>
            ...
            <p className="mt-4 text-xs text-white/30">Free to start · No card needed · Discord OAuth</p>
          </div>
      ...
      <section className="px-5 pb-16 pt-8 sm:px-8"><div className="cta-panel mx-auto max-w-7xl text-center"><div className="relative z-10 mx-auto max-w-2xl"><BarChart3 className="mx-auto size-7 text-blue-300" /><h2 className="mt-5 text-4xl font-semibold tracking-[-0.05em] text-white sm:text-5xl">A better way to run the group.</h2><p className="mx-auto mt-4 max-w-xl text-sm leading-7 text-white/48">Sign in with Discord, create your workspace, and connect the community you operate.</p><Link href="/dashboard" className="button-glow mt-8 inline-flex h-12 items-center gap-2 rounded-xl px-5 text-sm font-semibold text-white">Open Nexora Rank <ArrowRight className="size-4" /></Link></div></div></section>
...
function TrustItem({ title, text }: { title: string; text: string }) { return <article className="trust-item"><ShieldCheck className="size-5 text-blue-300" /><h3>{title}</h3><p>{text}</p></article>; }
