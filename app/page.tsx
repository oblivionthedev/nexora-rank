          ...
          <div className="grid items-end gap-x-16 gap-y-9 lg:grid-cols-[1.12fr_0.88fr]">
            <div>
              ...
              <h1 className="mt-6 font-display text-[clamp(2.7rem,5.6vw,5.1rem)] font-extrabold leading-[0.96] tracking-[-0.03em] text-white">
                Run your group.
                <br />
                <span className="text-[#e8c489]">Not the busywork.</span>
              </h1>
            </div>
                            ...
                            <svg viewBox="0 0 500 150" role="img" className="w-full">
                              <defs>
                                <linearGradient id="pulse" x1="0" x2="0" y1="0" y2="1">
                                  <stop offset="0" stopColor="#dda451" stopOpacity=".3" />
                                  <stop offset="1" stopColor="#dda451" stopOpacity="0" />
                                </linearGradient>
                              </defs>
                              ...
                              <path d="M0 122 C45 114 54 82 98 91 S160 105 200 66 S273 96 310 54 S374 75 414 38 S465 42 500 22" fill="none" stroke="#dda451" strokeWidth="2.2" strokeLinecap="round" />
                            </svg>
                          </div>
                        </div>
      ...
      <ul className="space-y-3">
        {items.map((item) => (
          <li key={item} className="flex items-center gap-2.5 text-sm text-white/70">
            <Check className="size-3.5 flex-none text-[#e8c489]" aria-hidden="true" />
            {item}
          </li>
        ))}
      </ul>
