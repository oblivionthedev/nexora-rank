...
export default async function GroupsPage() {
  ...
  const { data } = await supabase
    .from("nexora_groups")
    .select("id,roblox_group_id,roblox_group_name,roblox_group_logo_url,roblox_member_count,roblox_owner_username,roblox_owner_display_name,discord_invite_url")
    .eq("published", true)
