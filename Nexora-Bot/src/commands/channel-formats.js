        ...
        footer(
          new EmbedBuilder()
            ...
            .addFields(
              ...
              { name: "Is Roblox verification required?", value: "Yes. Nexora verification securely binds your Discord identity to a Roblox account through official Roblox OAuth. Passwords and Roblox cookies are never requested." },
              ...
              { name: "How do I become verified?", value: `Use the button below or open [Nexora Verification](${config.siteUrl}/verify). Connect Discord and Roblox, confirm server membership, then finish the check to receive access.` },
        ...
        footer(
          new EmbedBuilder()
            ...
            .addFields(
              ...
              { name: "3 · Connect both identities", value: "Confirm Discord, then authorize Roblox on Roblox's official OAuth page. Nexora receives only the permissions you approve—not passwords or cookies." },
              { name: "4 · Complete the website check", value: "Press **Finish verification** after all checks pass. The Verified role, nickname sync, and private receipt are handled automatically." },
